...
(function(root, factory) {
  ...
  var DEFAULTS = {
    ...
    'breadcrumbs': true,         // Show or hide breadcrumbs on start(). `true` or `false`.
    ...
    'transition': 'cube'        // The default transition to apply. `cube`, `linear`, `fade`, or `none`.
  };
